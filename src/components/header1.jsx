...
import PixaliveLogo from "../../assets/Home/pixalive.png"; // <-- Add correct relative path to the image you uploaded

const Footer = () => {
  return (
    <footer className="bg-black text-white px-4 md:px-12 pt-16 pb-10 text-l relative overflow-hidden">
      <div className="flex flex-col md:flex-row justify-between gap-10 md:gap-20 z-10 relative">
        {/* Left Section */}
        ...
        <div className="flex flex-col justify-between md:w-1/3">
          ...
          <div className="flex justify-end space-x-52 text-xs text-gray-400 mt-8 md:mt-0">
...
<br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br />
      {/* Pixalive Large Text Logo Image */}
      <img
        src={PixaliveLogo}
        alt="Pixalive Footer Logo"
        className="absolute bottom-0 left-0 w-full object-cover z-0 opacity-100"
      />
    </footer>
  );
};
