...
// Import your images
import Img1 from "../../assets/Home/reco1.png";
import Img2 from "../../assets/Home/reco2.png";
import Img3 from "../../assets/Home/reco3.png";
import Img4 from "../../assets/Home/reco4.png";
  ...
  return (
    <div className=" px-4 md:px-12 py-10 relative">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl md:text-3xl font-meadium text-gray-800">Recommended</h2>
